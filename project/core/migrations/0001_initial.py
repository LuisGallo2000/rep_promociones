...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CanalCliente',
            fields=[
                ('canal_id', models.CharField(editable=False, max_length=20, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_cliente', models.CharField(choices=[('mayorista', 'Mayorista'), ('cobertura', 'Cobertura'), ('todos', 'Todos')], default='todos', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.empresa')),
                ('grupo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.grupoproveedor')),
            ],
        ),
        migrations.CreateModel(
            name='Linea',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_beneficio', models.CharField(choices=[('bonificacion', 'Bonificación'), ('descuento', 'Descuento')], max_length=20)),
                ...
                ('articulo_bonificado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bonificaciones_escala', to='core.articulo')),
